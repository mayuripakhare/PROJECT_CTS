function validate()
{
	...
	if(FullName.value.trim() ==""|| Address.value() ==""|| ContactNo.value.trim() ==""|| Gender.value() ==""|| DateOfBirth.value.trim() ==""|| UserName.value.trim() ==""|| Password.value.trim() ==""|| ConfirmPassword.value.trim() ==""|| EmailAddress.value.trim() =="")
		{
